...
let menuIcon = document.getElementById("bur")
...
submitBtn.addEventListener("click", function(){
    ...
    let mailtoLink =  `mailto:nardoschachidaniel@gmail.com?subject= Went to Contact&body=Name: ${first_name + " "+ last_name}%0D%0AEmail: ${email}%0D%0AComment: ${comment}`;
...
menuIcon.addEventListener("click",function(){
    ...
    menuBar.classList.toggle("is-hidden-mobile")
